...
- **Contentsquare tracking** — Add Contentsquare tracking to the website for heatmaps and session recording. Remember to update the privacy and cookie policies to include Contentsquare. Make sure cookie consent is working correctly.
